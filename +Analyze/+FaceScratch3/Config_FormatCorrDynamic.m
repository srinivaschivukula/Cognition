function opts=Config_FormatCorrDynamic(GlobalOpts,varargin);
...
opts.AnalysisFCN={@Analyze.FaceScratch3.PopAnal_FormatCorrShuffDynamic,'DecodeTest'};
...
Analysis2Perform=[1];
    ...
    opts.PlotFCN={ ...
        @Analyze.FaceScratch3.PlotPop_FormatCorrDynamic ,'CorrThroughTimeA',{'rescale',1};...        
%         @Analyze.sFaceScratch3.PlotPop_FormatCorrDynamicTiming ,'CrossFormatTimeComp',{'rescale',1};...        
