function CrossCorrLimitedConditions(OutDir,Tag,varargin)
...
Condition={ 'NancyPinchCheek','NancyPressCheek',...
    'TysonPinchCheek','TysonPressCheek',...
    'NancyPinchShoulder','NancyPressShoulder',...
    'TysonPinchShoulder','TysonPressShoulder'};
