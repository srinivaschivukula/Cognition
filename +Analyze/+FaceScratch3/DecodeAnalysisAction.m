function DecodeAnalysisAction(AllTrialData,Labels,DecodeLabels,TimeWindow,OutDir,Tag,varargin)
...
pnl = panel();  pnl.margin=10; pnl.pack(1,3); pnl(1,1).pack('v',{3/4,1/4},'h',{1/4,3/4})
...
vline(0.5:4:NConds+0.5,'k')
hline(0.5:4:NConds+0.5,'k')
