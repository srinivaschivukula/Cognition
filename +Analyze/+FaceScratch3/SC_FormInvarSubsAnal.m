...
GlobalOpts.windowDuration.('Go')=2.500;
...
GlobalOpts.AnalysesName='Subspace';
GlobalOpts.PlotShuffle=0;
Dates=GlobalOpts.Dates;
if GlobalOpts.RunInline
    for i=1:length(Dates)
        AU.PopulationAnalysisThroughTime(@Analyze.FaceScratch3.Config_FormInvarSubsAnal ,GlobalOpts,'Dates',Dates(i));
    end
end
...
if GlobalOpts.RunPlots
    AU.PlotPopulationAnalThroughTime(@Analyze.FaceScratch3.Config_FormInvarSubsAnal,GlobalOpts);
end
